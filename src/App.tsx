          ...
          <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-gray-100 dark:border-slate-800 shadow-sm overflow-hidden relative">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-slate-800/50 p-6 rounded-3xl border border-gray-100 dark:border-slate-700/50 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                    <div className="md:col-span-5">
                      <input 
                        ...
                        onChange={(e) => setNewMedicine((prev: any) => ({ ...prev, name: e.target.value }))}
                    ...
                    <div className="md:col-span-3">
                      <input 
                        ...
                        onChange={(e) => setNewMedicine((prev: any) => ({ ...prev, dosage: e.target.value }))}
                        className="w-full px-4 py-3 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 outline-none text-gray-900 dark:text-white dark:placeholder:text-gray-500"
                      />
                    </div>
                    <div className="md:col-span-3">
                      <input 
                        ...
                        onChange={(e) => setNewMedicine((prev: any) => ({ ...prev, duration: e.target.value }))}
                        className="w-full px-4 py-3 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 outline-none text-gray-900 dark:text-white dark:placeholder:text-gray-500"
                      />
                    </div>
...
function usePageMeta() {
  ...
  const titles: Record<string, { title: string; subtitle: string }> = {
    '/': { title: 'Dashboard', subtitle: 'Good morning, Dr. Aryan. Here is your clinic overview.' },
...
export default function App() {
  ...
  // Apply on mount in case localStorage differs from html class (rare edge)
  useEffect(() => {
    applyTheme(darkMode);
...
// ─── PageHeader (needs router hooks, defined after BrowserRouter wraps app) ───
